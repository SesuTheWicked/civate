...
const Navbar = () => {
  ...
  return (
      ...
      <nav className='navv'>
        <a href="/" className='nav_brand'>CICATE </a>
          <ul className={active}>
            ...
            <li className='nav_item'><a href="/" className='nav_link'><img alt='img' src={vector2} className='vector'/>Institutions</a> </li>
            <li className='nav_item'><a href="/" className='nav_link'><img alt='img' src={vector3} className='vector'/>About Us</a> </li>
   ...
   <a href="/test_format" className="test_format_button">Test Format</a>
